...
I [just finished](https://github.com/maxjacobson/hardscrabble.net/pull/19) updating my blog to Jekyll 2.0. It looks the same, but the code is nicer.[^qualifier]
...
The marquee feature is that Jekyll now knows how to compile Sass and CoffeeScript. I was already using those languages, but relying on a [complex Guardfile](https://github.com/maxjacobson/hardscrabble.net/blob/ad915235d6875074d435f2609b562cb7252b9fab/Guardfile) to accomplish it. I'm pleased to delete that.
