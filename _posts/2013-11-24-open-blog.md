...
This blog is open for business. Also it's open like, it's on [on github](https://github.com/maxjacobson/hardscrabble.net), which means you can fork it, read the drafts, submit pull requests, etc.
